...
public class TariffsSaxBuilderTest {
    ...
    private TariffsSaxBuilder saxBuilder;
    private String fileName;
    private Set<Tariff> expectedSet;

    @BeforeMethod
    public void setUp() {
        saxBuilder = (TariffsSaxBuilder) TariffsBuilderFactory.createTariffBuilder("sax");
    ...
    public void testBuildSetTariffs() {
        saxBuilder.buildSetTariffs(fileName);
        Set<Tariff> actualSet = saxBuilder.getTariffs();
