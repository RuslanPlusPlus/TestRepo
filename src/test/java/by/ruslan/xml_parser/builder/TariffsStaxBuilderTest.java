...
public class TariffsStaxBuilderTest {
    ...
    private TariffsStaxBuilder staxBuilder;
    private String fileName;
    private Set<Tariff> expectedSet;

    @BeforeMethod
    public void setUp() {
        staxBuilder = (TariffsStaxBuilder) TariffsBuilderFactory.createTariffBuilder("stax");
    ...
    public void testBuildSetTariffs() {
        staxBuilder.buildSetTariffs(fileName);
        Set<Tariff> actualSet = staxBuilder.getTariffs();
